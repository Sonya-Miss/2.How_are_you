...
function createAudioGameWordBank() {
    ...
    shuffleArray([...audioPuzzlesData]).forEach(({ word }) => {
        ...
        wordEl.className = "audio-draggable-word bg-blue-300 hover:bg-blue-400 text-white font-bold py-3 px-6 rounded-lg cursor-grab active:cursor-grabbing transition-transform duration-100 ease-out";
